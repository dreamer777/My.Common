...
{
    /// <summary>
    ///     Without paging - Select(string orderBy)
    /// </summary>
    public interface IPageWithOneStatFilterWoPaging<TFinder> where TFinder : FinderBase<TFinder>
    {
        /// <summary>
        ...
        [UsedImplicitly]
        IEnumerable<object> Select(string orderBy);
    }
}